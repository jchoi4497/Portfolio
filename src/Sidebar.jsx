...
function SideBar() {
  return (
    <div className="w-full md:w-[442px] pl-3 pt-6 h-screen fixed md:static font-mersin overflow-auto relative">
      <h1 className="text-4xl font-bold mb-4 mt-5">Jonathan Choi</h1>

      <div className="relative flex flex-col gap-2 pr-6">

        <p className="text-lg font-thin md:border-r-8  md:border-black pr-4 break-words">
